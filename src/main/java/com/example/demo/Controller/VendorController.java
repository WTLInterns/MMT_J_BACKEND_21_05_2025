...
public class VendorController {
    ...
    @Autowired
    public VendorController(VendorService vendorService, CloudinaryService cloudinaryService, EmailService emailService) {
    ...
    public ResponseEntity<List<Vendor>> getAllVendors() {
        ...
        return ResponseEntity.ok(vendorService.getAllVendors(email));
    }
    ...
    public ResponseEntity<String> deleteVendor(@PathVariable int id) {
        ...
        String message = vendorService.deleteVendor(id,email);
    ...
    public ResponseEntity<?> addVendor(
        ...
        try {
            ...
            Vendor savedVendor = vendorService.saveVendor(vendor,email);

//            // Send confirmation email to the vendor
//            sendVendorConfirmationEmail(savedVendor);
    ...
    public ResponseEntity<?> updateVendor(
        ...
        try {
            ...
            Vendor updatedVendor = vendorService.updateVendor(id, vendorCompanyName, contactNo, alternateMobileNo,
                    city, vendorEmail, bankName, bankAccountNo, ifscCode, aadharNo, panNo, udyogAadharNo,
                    govtApprovalCertificateUrl, vendorDocsUrl, vendorImageUrl, aadharPhotoUrl, panPhotoUrl, vendorOtherDetails,email);

            return ResponseEntity.ok(generateVendorResponse(updatedVendor));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
